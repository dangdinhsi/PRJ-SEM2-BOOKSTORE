...
<head>
    ...
    <link rel="stylesheet" href="{{('front-end/css/tai-khoan.css')}}">
                    ...
                    <div class="dropdown">
                        <li class="nav-item account d-flex" type="button" class="btn dropdown" data-toggle="dropdown">
                            ...
                            <div class="info-logout">
                                <a class="nav-link text-dark text-uppercase username" href="account.html">SIDDD00474</a>
                        ...
                        <div class="tab-pane fade show active pl-4 " id="nav-taikhoan" role="tabpanel" aria-labelledby="nav-taikhoan-tab">
                            ...
                            <div class="hoten my-3">
                                <div class="row">
                                    ...
                                    <input class="col-md-4" type="text" name="account-hoten" disabled="disabled" value="Đặng Đình Sĩ">
                                </div>
                            </div>
                            <div class="email my-3">
                                <div class="row">
                                    <label class="col-md-2 offset-md-2" for="account-email">Địa chỉ email</label>
                                    <input class="col-md-4" type="text" name="account-email" disabled="disabled" value="siddd00474@fpt.edu.vn">
                                </div>
                            </div>
