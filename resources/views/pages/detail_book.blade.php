                ...
                <div class="row">
                    ...
                    <div class="col-md-5 khoianh">
                        <div class="anhto mb-4">
                            <a class="active" href="{{('front-end/images/lap-ke-hoach-kinh-doanh-hieu-qua-mt.jpg')}}" data-fancybox="thumb-img">
                                <img class="product-image" src="{{('front-end/images/lap-ke-hoach-kinh-doanh-hieu-qua-mt.jpg')}}" alt="lap-ke-hoach-kinh-doanh-hieu-qua-mt" style="width: 100%;">
                            </a>
                            <a href="{{('front-end/images/lap-ke-hoach-kinh-doanh-hieu-qua-ms.jpg')}}" data-fancybox="thumb-img"></a>
                        </div>
                        <div class="list-anhchitiet d-flex mb-4" style="margin-left: 2rem;">
                            <img class="thumb-img thumb1 mr-3" src="{{('front-end/images/lap-ke-hoach-kinh-doanh-hieu-qua-mt.jpg')}}" class="img-fluid" alt="lap-ke-hoach-kinh-doanh-hieu-qua-mt">
                            <img class="thumb-img thumb2" src="{{('front-end/images/lap-ke-hoach-kinh-doanh-hieu-qua-ms.jpg')}}" class="img-fluid" alt="lap-ke-hoach-kinh-doanh-hieu-qua-ms">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="gia">
                                    ...
                                    <div class="giaban">Giá bán tại SIXSTORE: <span
                                ...
                                <div class="uudai my-3">
                                    <h6 class="header font-weight-bold">Khuyến mãi & Ưu đãi tại SIXSTORE:</h6>
                                    <ul>
                                ...
                                <a class="huongdanmuahang text-decoration-none" href="#">(Vui lòng xem hướng dẫn mua
                                    hàng)</a>
                                <small class="share">Notifications </small>
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                ...
                <div class="khoisanpham" style="padding-bottom: 2rem;">
                    ...
                    <div class="card">
                        ...
                        Trí">
                            <img class="card-img-top anh" src="{{('front-end/images/ma-bun-luu-manh.jpg')}}" alt="ma-bun-luu-manh">
                            <div class="card-body noidungsp mt-3">
                ...
                <div class="khoisanpham">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{'front-end/images/combo-chuyen-nghe-chuyen-doi.jpg'}}" alt="combo-chuyen-nghe-chuyen-doi">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat.jpg')}}" alt="combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-hanh-phuc-sang-tao.jpg')}}" alt="combo-hanh-phuc-sang-tao">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-giao-duc-va-y-nghia-cuoc-song.jpg')}}" alt="combo-giao-duc-va-y-nghia-cuoc-song">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-dinh-duong-than-duoc-xanh.jpg')}}" alt="combo-dinh-duong-than-duoc-xanh">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-an-xanh-song-lanh.jpg')}}" alt="combo-an-xanh-song-lanh">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-luoc-su-loai-nguoi.jpg')}}" alt="combo-luoc-su-loai-nguoi">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="{{('front-end/images/combo-phong-cach-song.jpg')}}" alt="combo-phong-cach-song">
                            <div class="card-body noidungsp mt-3">
