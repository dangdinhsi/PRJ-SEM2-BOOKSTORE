...
<head>
    <title>SixStore-Mua sách trực tuyến giá rẻ nhất</title>
    ...
    <link rel="canonical" href="http://sixstore.net/">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        <h3 class="header text-uppercase font-weight-bold">Về SIXSTORE</h3>
